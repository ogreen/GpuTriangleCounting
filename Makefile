...
$(GPURUN): $(GPURUNDEPS)
	$(COMPILE) -c src/gpurun.cu -Xcompiler -fopenmp -lgomp -o $(GPURUN)
...
$(EXEC): $(EXECDEPS)
	$(COMPILE) $(EXECDEPS) -lnvToolsExt -Xcompiler -fopenmp -lgomp -o $(EXEC)
	g++ -std=c++11 src/csrdatacreate.cpp -lmetis -fopenmp -lgomp -o bin/csr
